...
public enum ErrorEnum {
    ...
    ERR_REBOOT_INSTANCE_BODY(153, "cloudmp.core.instance.rebootInstanceBodyError", "重启主机请求体错误"),
    ...
    //##########disk错误code(301——350)##########
    ERR_MODIFY_DISK_NAME_BODY(301, "cloudmp.core.disk.modifyDiskNameBodyError", "修改硬盘名称请求体错误"),
